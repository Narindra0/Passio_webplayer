/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 16636144d18a1a2fa5d7217ab59c696d)
// Runtime types generated with workerd@1.20260710.1 2026-06-17 nodejs_compat
interface __BaseEnv_Env {
	STREAMS_KV: KVNamespace;
	ANALYTICS_DB: D1Database;
	VITE_API_URL: string;
	VITE_PURCHASE_BASE_URL: string;
	VITE_CLOUDFLARE_AUDIO_BASE_URL: string;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/workers/streams-api");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_API_URL" | "VITE_PURCHASE_BASE_URL" | "VITE_CLOUDFLARE_AUDIO_BASE_URL">> {}
}
